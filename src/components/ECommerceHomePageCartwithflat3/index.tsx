...
interface Props {
  ...
  onehundredtwent?: string;
  onehundredsixty?: string;
  eightyeight?: string;
}

export default function ECommerceHomePageCartwithflat3({
  discount = "-40%",
  ...
  return (
    <div {...props}>
      <div className="flex flex-row justify-center w-full p-3 bg-gray-100 rounded">
        <div className="flex flex-row justify-start items-start w-full mb-[37px] gap-[3px] max-w-[246px]">
          <div className="flex flex-col items-start justify-start w-[85%] gap-[11px]">
            <Button color="red_600" size="sm" shape="round" className="min-w-[55px]">
              {discount}
            </Button>
            <div className="flex flex-row justify-end ml-[37px]">
